...
<?php include('includes/sidebar.php');?>
 ...
 <?php $query=mysqli_query($con,"select tblcomplaints.*,department.departmentName as deptname from tblcomplaints join department on department.id=tblcomplaints.department where userId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");
...
<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Department :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['deptname']);?></p>
              </div>
...
<label class="col-sm-2 col-sm-2 control-label"><b>ID code:</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['rollno']);?></p>
              </div>
            </div>  
