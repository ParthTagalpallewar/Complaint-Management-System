...
$ret=mysqli_query($con,"SELECT * FROM users WHERE userEmail='".$_POST['username']."' and password='".md5($_POST['password'])."' and status11 = 'active'");
...
$status=1;
// $_SESSION['msg'] = "Check your account to activate ".$_POST['username'];
...
return true;
  ...
  <body>
	...
	<!-- <div><p class="bg-success text-white px-4"><?php 
	// echo $_SESSION['msg'];?></p></div> -->
		      <form action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>"class="form-login" name="login" method="POST">
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		        	 <div>
		        		<p class="bg-info text-black px-2 ">
		        			<font size="2.5"><b>Check your Email account for login </b>
		        			</font>
		        		</p>
		        	</div> 

		        	<div>
		        		<P class="bg-success text-white px-10">
